...
3. He starts to edit the text file named `day1_itenerary.txt` and saved the file locally.

    ![GitHub Login Page](../images/4_1/4_1_4.png)

4. In order to share the changes with the group, he has to "push" the updates into the remote repository. After he is done with editing of the text file, he then stage, commit and push the files with the following:
    ```
    git add .
